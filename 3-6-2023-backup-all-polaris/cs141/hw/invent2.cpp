...
void printRecord(string product_name,double wholesale_price,int quantity,double retail_price,double total_price_paid);
...
void printRecord(string product_name,double wholesale_price,int quantity,double retail_price,double total_price_paid){
  ...
  cout<<product_name<<", "<<wholesale_price<<", "<<quantity<<", "<<retail_price<<", "<<(retail_price*quantity)-total_price_paid<<endl;
